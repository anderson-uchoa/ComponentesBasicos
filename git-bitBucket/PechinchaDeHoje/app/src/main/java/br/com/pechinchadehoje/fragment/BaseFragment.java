...
public abstract class BaseFragment extends Fragment {
    ...
    public void startTask(String cod, TaskListener listener, int progressId) {
        Log.d("debugfragment", "startTask: " + cod);
        View view = getView();
        if (view == null) {
    ...
    private class Task extends AsyncTask<Void, Void, TaskResult> {
        ...
        protected void onPreExecute() {
            Log.d("debugfragment", "task onPreExecute()");
        ...
        protected TaskResult doInBackground(Void... params) {
            ...
            try {
                ...
                Log.e("debugfragmente", e.getMessage(), e);
                r.exception = e;
            }
            return r;
        }
        ...
        protected void onPostExecute(TaskResult result) {
            Log.d("debugfragmente", "task onPostExecute(): " + result);
            try {
                if (result != null) {
